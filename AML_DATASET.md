...
|------|---------|---------|
| `mappings/aml-mapping.json` | H2 / Standard SQL | `aml_demo_queries.ipynb` |
| `mappings/iceberg-local-mapping.json` | Trino + Iceberg | `aml_iceberg_queries.ipynb` |
| `demo/mappings/aml-mapping.json` | H2 / Standard SQL | Demo module copy |
...
| `aml_demo_queries.ipynb` | Gremlin + SQL demo notebook (Standard SQL / H2) |
| `aml_iceberg_queries.ipynb` | Gremlin + SQL demo notebook (Iceberg / Trino) |

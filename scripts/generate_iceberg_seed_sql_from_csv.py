...
def main() -> None:
    ...
    emit_insert(lines, "iceberg.aml.accounts", ["id", "account_id", "bank_id", "risk_score"], rows["accounts"])
    emit_insert(lines, "iceberg.aml.transfers", ["id", "out_id", "in_id", "amount", "currency", "is_laundering"], rows["transfers"])

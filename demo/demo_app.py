...
Usage (from notebook):
    ...
    app = DemoApp()
    app.start()                     # starts the Java service
...
class DemoApp:
    ...
    DEFAULT_MAPPING_PATH = "demo/mappings/aml-mapping.json"
    ...
    def load_csv(
        ...
        *,
        ...
        mapping_path : str | Path | None
            Path to the mapping JSON. Defaults to ``demo/mappings/aml-mapping.json``.
        verbose : bool
